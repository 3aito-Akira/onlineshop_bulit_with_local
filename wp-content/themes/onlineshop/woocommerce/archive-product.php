...
echo( "<p>before woocommerce_before_main_content </p>");
do_action( 'woocommerce_before_main_content' );
echo( "<p>after woocommerce_before_main_content </p>");
...
echo( "<p>after woocommerce_shop_loop_header </p>");

if ( woocommerce_product_loop() ) {
	echo( "<p>woocommerce_product_loop() starts </p>");
